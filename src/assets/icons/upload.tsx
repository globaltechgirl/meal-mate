  ...
  >
    <g className="bullseye-outline">
      <g fill="currentColor" fill-rule="evenodd" className="Vector" clip-rule="evenodd">
        ...
        <path d="M7.285 10.1a1 1 0 0 1 .016-1.415l4.5-4.4a1 1 0 0 1 1.398 0l4.5 4.4a1 1 0 1 1-1.398 1.43L13.5 7.376V16a1 1 0 1 1-2 0V7.376l-2.8 2.739a1 1 0 0 1-1.415-.016Z"/>
      </g>
    </g>
  </svg>
);
