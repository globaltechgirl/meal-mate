...
const DetailsInfo: FC = () => {
  ...
  const [name, setName] = useState("Delicious Pasta");
  ...
  const [lastMade, setLastMade] = useState("2025-10-01");
    ...
    <Box style={styles.contentWrapper}>
      ...
      >
        ...
        <Box style={styles.hoverWrapper}>
          <Box
            style={{ ...styles.hoverBox, ...(hovered ? styles.hoverVisible : {}) }}
            onClick={() => setStarred((prev) => !prev)}
          >
            {starred ? <StarredIcon width={16} height={16} /> : <StarIcon width={16} height={16} />}
          </Box>

          <Box style={{ ...styles.hoverBox, ...(hovered ? styles.hoverVisible : {}) }}>
        ...
        <Box style={styles.detailsMain}>
          <Box style={styles.detailsBox}>
            {isEditingName ? (
              ...
              <Text style={styles.recipeName} onClick={() => setIsEditingName(true)}>
                {name}
              </Text>
            )}
            ...
            <Box style={styles.boxColumn}>
              ...
              {isEditingDescription ? (
                ...
                <Text style={styles.descriptionText} onClick={() => setIsEditingDescription(true)}>
                  {description}
                </Text>
              )}
            </Box>
                ...
                <Box style={styles.timeBox}>
                  ...
                  {isEditingTime ? (
                    <input
                      ...
                      autoFocus
                      style={{ ...editableInputStyle, width: 50 }}
                    />
                  ) : (
